***************************************
TVOS_SIMULATOR_DEVICE_ID
***************************************

.. cmake:envvar:: TVOS_SIMULATOR_DEVICE_ID

.. include:: env-var.txt

This variable tells the ``tvOS`` CMake preset what simulator device ID to use for running presets (via the ``test-ios.sh`` script).
